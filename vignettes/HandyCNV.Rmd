...
Once we got the standard `clean_cnv` result, we can use the `cnv_visual` function to plot all CNVs, to have a quick look if there are any notable patterns in CNV results.<br>
...
cnv_visual(clean_cnv = "cnv_clean/penncnv_clean.cnv", #standard file was generated by 'cnv_clean' function in section 1
           ...
           col_0 = "red", #optional, customize color for 0 copy CNVs 
           col_1 = "orange", #optional, customize color for 1 copy CNVs 
           col_3 = "blue", #optional, customize color for 3 copy CNVs 
           col_4 = "green", #optional, customize color for 4 copy CNVs 
