...
```{r}
#setwd(dir = "C:/Users/handy_test") #remember to repalce the path with your own 
```
...
```{r cnv_summary_plot_penn, fig.show='hide'}
...
```{r cnv_summary_plot_part, fig.show='hide'}
...
```
![Figure.11 Comparion of CNV on Individual and Population Level](compare_cnv_PartUMD_Vs_PennUMD/combine_figure.png){width=320px}
