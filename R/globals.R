...
utils::globalVariables(c(".", "..count..", "ARS_Density", "B Allele Freq", "CNVR_ID", "CNV_Number", "CNV_Value", "Check_gene", "Check_overlap",
                         "Chr", "Chr_ARS", "Chr_UMD", "Chr_def", "Chr_tar", "Common_Gene", "Common_check", "Difference", "End", "End_2", "End_ARS",
                         "End_ARS_Map", "End_Match", "End_UMD", "End_win", "Frequency_1", "Frequency_2", "Frequency_3", "Frequency_4", "Frequent",
                         "Group", "Herd", "ID", "Length", "Log R Ratio", "Match", "Mb_tar", "Name", "Order", "Overlap_length", "Position_def",
                         "Position_tar", "SNP_Freq_def", "SNP_Freq_tar", "Sample_ID", "Sample_ID_ARS", "Sample_ID_UMD", "Sire_ID", "Sire_Source",
                         "Start", "Start_2", "Start_ARS", "Start_ARS_Map", "Start_Match", "Start_UMD", "Start_win", "Type", "UMD_Density", "V1",
                         ...
                         "End_def", "End_tar", "Start_def", "Start_tar", "converted_len", "length_diff", "original_len", "qc_check"))
