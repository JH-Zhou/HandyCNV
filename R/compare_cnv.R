#' Compare  CNV
#'
#' The idea to compare CNVs between different results are find out how many different are there in both individual and population level.
#' For CNVs we more concern about the number and proportion of overlapped CNVs.
#'
#' Six comparison standards of CNV were defined:
#' 1) overlapped
...
#'
#' @param cnv_def 'def' is 'default' indicate the first CNV input file, the standard file was generated by 'clean_cnv' function
#' @param cnv_tar 'tar' is 'target' indicate the second CNV input file, the standard file was generated by 'clean_cnv' function
#' @param def_tar_map map file contains coordinates in both version of map. only need in comparison between the results from different versions. standard file was generated by 'convert_map' function
#' @param width_1 integer, default value is 14, set the width of final plot size, unit is 'cm'
#' @param height_1 integer, default value is 11, set the height of final plot size, unit is 'cm'
