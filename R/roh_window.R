...
#' @param window_size the length of sliding windows for deviding the chromosome, the unit is Mb
#' @param length_autosomal total autosomal length of the corresponding species
...
roh_window <- function(roh, window_size = 5, length_autosomal = 2489.386, threshold = 0.3) {
  ...
  windows_plot <- plot_roh(roh_freq = roh_freq, threshold = threshold)
  print(windows_plot)
  dev.off()
