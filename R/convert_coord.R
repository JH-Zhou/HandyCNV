...
convert_coord <- function(input_tar = NULL, input_def = NULL, def_tar_map, proxy_range = 20000, len_diff_threshold = 100000, folder = "convert_coord"){
  ...
  if(all(colnames(map) == standard_map)){
    print("'def_tar_map' file was passed input check...")
  } else{
    print("'def_tar_map' file was Failed Pass input check! Standard file was generated by 'convert_map' funcion, see the standard format as follows:")
    print(standard_map)
  }
  ...
  if (is.null(input_def)) {
    ...
    clean_conv_len <- sum(cnvr_right_clean$converted_len)
